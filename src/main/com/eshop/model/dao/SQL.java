...
public class SQL {
	...
	public static final String SELECT_ORDER_ITEMS = "SELECT product.*, order_item.amount as item_amount FROM order_item" + 
		" INNER JOIN product ON order_item.product_id = product.id WHERE order_id = ?";
