...
<!DOCTYPE html>
		...
		<body style="background: #fcf767;">
			...
			<h1 align="center"><fmt:message key="edit"/> <fmt:message key="product"/></h1>
			<div align="center">
				<form action="${context_path}/controller/update-product" method="POST">
					...
					<input type="submit" value="<fmt:message key="edit"/>" style="background: #fffb00; font-size: 30px; border-radius: 15px;">
				</form>
			</div>
		</body>
	</html>
